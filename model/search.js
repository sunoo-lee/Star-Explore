...
const search = function (SEsong) {
	this.song_title = SEsong.songtitle;
	this.pronunciation = SEsong.pronunciation;
	this.translation = SEsong.translation;
}
...
search.searchBybar = (SEsonginfo, result) => {
	...
	db.getConnection(function (err, connection) {
		...
		if (!err) {
			...
			let query_to_find_title = `SELECT song_title FROM total_songs_information
